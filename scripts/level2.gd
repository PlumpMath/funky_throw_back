...
class Level2:
	...
	var stage3 = level_stage.new().setup(dialogue3, move_time3, move_playback_time3, moves3, num_freestyle_moves3, freestyle_time3, speaker_name)
